...
![CI](https://github.com/matsuu6235/RetailNexus/actions/workflows/ci.yml/badge.svg)
...
| 認可 | ロール×権限モデル・カスタム認可属性 `[RequirePermission]`・43権限コード |
...
| 発注管理 | 一覧・作成・編集・詳細・承認フロー（下書き→承認待ち→承認済→ステータス遷移→入荷済）・商品重複チェック・仕入単価自動セット・明細個別更新・自動採番（PO-000001） |
